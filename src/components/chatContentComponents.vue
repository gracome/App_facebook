<template>
  ...
  <div class="main-layout">
    ...
    <div class="navigation navbar navbar-light bg-primary">
      <!-- Logo Start -->
      <a
        class="d-none d-xl-block bg-light rounded p-1"
        href="./../../index.html"
      >
        <!-- Default :: Inline SVG -->
      ...
      >
        ...
        <li class="nav-item">
          <a
            class="nav-link p-0 py-xl-3 active"
            id="chats-tab"
            href="#chats-content"
            title="Chats"
          >
          ...
          <div class="d-flex flex-column h-100">
            <div class="hide-scrollbar h-100" id="chatContactsList">
              ...
              <ul class="contacts-list" id="chatContactTab" data-chat-list="">
                <!-- Chat Item Start -->
                <li
                  class="contacts-item friends"
                  v-for="(chat, x) in this.$store.getters.chats"
                  :key="x"
                >
                  <span
                    class="contacts-link"
                  ...
                  >
                    <div class="avatar avatar-online">
                      <img
                        src="https://scontent-sea1-1.xx.fbcdn.net/v/t1.30497-1/84628273_176159830277856_972693363922829312_n.jpg?stp=dst-jpg_p720x720&_nc_cat=1&ccb=1-7&_nc_sid=12b3be&_nc_ohc=qIPCd3XtmYYAX_FfqnE&_nc_ht=scontent-sea1-1.xx&edm=AP4hL3IEAAAA&oh=00_AfDB375RdC6qypjH9vmaFYRvJYur9sViw4SgPu-jxB1Fog&oe=63DFE499"
                        alt=""
                      />
                    </div>
          ...
          <div class="d-flex flex-column h-100">
            <div class="hide-scrollbar" id="friendsList">
              ...
              <ul class="contacts-list" id="friendsTab" data-friends-list="">
                ...
                <!-- friends Item Start -->
                <li class="contacts-item" v-for="user in users" :key="user.id">
                  <span
                    class="contacts-link"
                    @click="change_Active_users({ id: user.id })"
                  >
                    <div class="avatar">
                      <img
                        src="../../public/assets/media/avatar/3.png"
                        alt=""
                      />
                    </div>
                    <div class="contacts-content">
                      <div class="contacts-info">
                        <h6 class="chat-name text-truncate">{{ user.nom }}</h6>
                      </div>
                      <div class="contacts-texts">
                        <!-- Default :: Inline SVG -->
                    ...
                    <div class="card card-body card-bg-5">
                      ...
                      <div class="card-options">
                        <div class="dropdown">
                          <button
                            class="
                              btn btn-secondary btn-icon btn-minimal btn-sm
      ...
      <div class="chats">
        <div
          class="
            ...
            w-100
          "
          v-if="!this.$store.getters.active.id"
        >
          <div class="container">
            ...
            <div class="hide-scrollbar flex-fill">
              ...
              <div class="text-center p-3">
                ...
                <div class="avatar avatar-xl mx-5 mb-3">
                  <img
                    class="avatar-img"
                    src="../../public/assets/media/avatar/2.png"
                    alt=""
                  />
                </div>
                ...
                <div class="d-flex align-items-center justify-content-center">
                  <div
                    class="btn btn-outline-default btn-icon rounded-circle mx-1"
                  >
                    <!-- Default :: Inline SVG -->
                    <svg
                      class="hw-20"
            ...
            <div class="col">
              ...
              <div class="card my-3">
                ...
                <div class="card mb-3">
                  ...
                  <div class="card-body">
                    <form @submit.prevent="ResetPassword">
                      <div class="form-group">
                        ...
                        />
                        <div v-if="isPasswordInvalid" class="invalid-feedback">
                      ...
                      <div class="form-group">
                        ...
                        <input
                          ...
                          ref="confirmpassword"
                          :class="{ 'is-invalid': isConfirmPasswordInvalid }"
                        />
                        <div
                          v-if="isConfirmPasswordInvalid"
                          class="invalid-feedback"
                        >
                          Ce champ est obligatoire
                        </div>
                  ...
                  <div class="card-footer d-flex justify-content-end">
                   <button type="button" class="btn btn-link text-muted mx-1" @click="errorMessage = null">Reset</button>
            ...
            >
              <div class="container">
                <div class="avatar avatar-lg mb-2">
                  <img
                    class="avatar-img"
                    src="../../public/assets/media/avatar/4.png"
                    alt=""
                  />
                </div>
              ...
              <div class="appnavbar-body">
                <div class="appnavbar-body-title">
                  <div class="dropdown w-100">
                    <!-- Dropdown Button Start -->
                    <button
                      class="btn btn-outline-default btn-block dropdown-toggle"
                      type="button"
                      data-toggle="dropdown"
                      aria-haspopup="true"
                      aria-expanded="false"
                  ...
                  <img
                    class="injetable hw-16 text-muted mx-1"
                ...
                <div class="translator-container p-2">
                  <div class="form-group">
                    <textarea
                      ...
                      name="description"
                    >
Rise and shine, buddy! It’s time to show this world who you are. I hope your morning is filled with peace and harmony, and you are ready to start your day. Hope that you’re starting it with a smile!</textarea
                    >
                  </div>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <p class="mb-0">
                        Et surge inluminare buddy! Aliquam quis es ut ostenderet
                        hoc mundo. Utinam impleatur concordiam mane et dies
                        incipere velis. Spes autem quae erant incipiens cum
                        risu!
                      </p>
                    </div>
                  </div>
                  ...
                  <div class="note">
                    <div class="note-body">
                      ...
                      <p class="note-description">
                        ...
                        Quis, dolorum odio vitae sapiente eius obcaecati.
                      </p>
                    </div>
    ...
    <div
      class="modal modal-lg-fullscreen fade"
              ...
              <div class="col-12">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="avatar avatar-online mr-2">
                        <!-- <img src="../../public/assets/media/avatar/1.png" alt=""> -->
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="avatar avatar-online mr-2">
                        <!-- <img src="../../public/assets/media/avatar/2.png" alt=""> -->
                      </div>
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      <div class="avatar avatar-away mr-2">
                        <img
                          src="../../public/assets/media/avatar/5.png"
                          alt=""
                        />
                      </div>
                ...
                <ul class="list-group list-group-flush py-2">
                  ...
                  <li class="list-group-item">
                    <div class="media">
                      ...
                      <div class="media-body">
                        <h6>
                          <a href="#">Catherine richardson</a> send you a friend
                          request
                        </h6>
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                <label for="addNoteName" class="col-form-label"
                  >Note title:</label
                >
                <input
                  type="text"
              ...
              <div class="form-group">
                <label for="addNoteDetails" class="col-form-label"
                  >Note details:</label
                >
                <textarea
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                <label for="editTaskName" class="col-form-label"
                  >Task name:</label
                >
                <input
                  type="text"
              ...
              <div class="form-group">
                <label for="editTaskDetails" class="col-form-label"
                  >Task details:</label
                >
                <textarea
                  class="form-control hide-scrollbar"
                ...
                >
Lorem ipsum dolor sit, amet consectetur adipisicing elit. Omnis temporibus vel, molestiae nobis dolor aut sapiente. Vero possimus molestias consequatur quod, quo rem autem molestiae, accusantium nemo culpa eos doloremque?
                        </textarea
                >
              </div>
            </form>
      ...
      >
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                <label for="addTaskName" class="col-form-label"
                  >Task name:</label
                >
                <input
                  type="text"
              ...
              <div class="form-group">
                <label for="addTaskDetails" class="col-form-label"
                  >Task details:</label
                >
                <textarea
                  class="form-control hide-scrollbar"
...
export default {
  ...
  computed: {
    ...
    isNewPasswordInvalid() {
      return this.form.Newpassword.trim() === '';
    },
    isConfirmPasswordInvalid() {
      return this.form.Confirmpassword.trim() === '';
    }
  },
  created() {
    this.get_chat();
  ...
  methods: {
    logout() {
      ...
      if (confirm("Voulez-vous vraiment vous déconnectez ?") == true) {
  ...
  try {
    ...
    if (this.isPasswordInvalid || this.isNewPasswordInvalid || this.isConfirmPasswordInvalid) {
      return;
    }

    // Vérifiez si les mots de passe correspondent
    if (this.form.Newpassword !== this.form.Confirmpassword) {
      this.errorMessage = "Les mots de passe ne sont pas corrects";
      return;
    }

    // Envoyez la demande de modification du mot de passe à l'API
    ...
    // Il y a eu un problème lors de l'exécution de la requête
    console.error(error);
    this.errorMessage = "Une erreur est survenue";
  }
},
    ...
    changeActiveChat(data) {
      this.$store.commit("set_active_chat", data);
      console.log("active chat id test", this.$store.getters.active.id);
    },
    get_chat() {
