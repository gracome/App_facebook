                                ...
                                <div class="card card-body card-bg-1 mb-3">
                                    <div class="d-flex flex-column align-items-center">
                                        <div class="avatar avatar-lg mb-3">
                                            <img class="avatar-img" src="../../public/assets/media/avatar/3.png" alt="">
                                        </div>
...
methods :{
    get_listUsers(){
        console.log('get')
        accountService.userDetail(this.$store.getters.activeUser.id).then((res) => {
            this.$store.commit('set_activeUser', res.data[0]);
        })
       
    }
},
mounted() {
    console.log(this.$store.getters.messages[0].message);
}
}
</script>
